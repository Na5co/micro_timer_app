...
class Solandra extends StatefulWidget {
  const Solandra({super.key});

  @override
  State<Solandra> createState() => _SolandraState();
}

class _SolandraState extends State<Solandra> with TickerProviderStateMixin {
